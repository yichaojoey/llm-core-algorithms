...
### 2. [REINFORCE (Vanilla Policy Gradient)](./REINFORCE/)
...
### 4. [DPO (Direct Preference Optimization)](./DPO/)
...
### 5. [GRPO (Group Relative Policy Optimization)](./GRPO/)
...
### 6. [GSPO (Group Sequence Policy Optimization)](./GSPO/)
...
For an ultra-detailed, code-level breakdown on the structural differences and dimensional changes when putting these probabilistic LLM algorithms into practice, read the comprehensive [RL-COMPARISON Guide](./RL-COMPARISON.md).
